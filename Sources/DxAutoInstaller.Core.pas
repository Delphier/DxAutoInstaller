...
type
  TApp = class
  const
    Version = {$I ..\Resources\Version.txt};
  end;
  ...
  private
    class function Win32Compiler(AIDE: TIDE): TCompiler; static;
    class function Win64Compiler(AIDE: TIDE): TCompiler; static;
  public
...
const
  ...
  PlatformCompilers          : array[TPlatform] of TCompilerGetter   = (TPlatform.Win32Compiler, TPlatform.Win64Compiler, TPlatform.Win64Compiler);
...
class function TPlatformHelper.Win32Compiler(AIDE: TIDE): TCompiler;
begin
  Result := AIDE.FIDE.DCC32;
end;

class function TPlatformHelper.Win64Compiler(AIDE: TIDE): TCompiler;
begin
