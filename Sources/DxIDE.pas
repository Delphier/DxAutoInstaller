...
const
  ...
  DxIDEPlatformNames: array[TDxIDEPlatform] of String = (
    BDSPlatformWin32, BDSPlatformWin32, BDSPlatformWin64, BDSPlatformWin64x,
    BDSPlatformOSX32, BDSPlatformOSX64, BDSPlatformAndroid32,
    BDSPlatformAndroid64, BDSPlatformiOSDevice32, BDSPlatformiOSDevice64,
    BDSPlatformiOSSimulator, BDSPlatformLinux64);
  BPLExtName = '.bpl';
